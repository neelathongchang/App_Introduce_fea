...
class ContactsPage extends StatefulWidget {
  ...
  @override
  State<ContactsPage> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ContactsPage> {
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                      labelText: 'ຊື່', hintText: 'eg.Elon'),
                ),
                TextField(
                  keyboardType: TextInputType.number,
                  controller: _snController,
                  decoration:
                  const InputDecoration(labelText: 'ລະຫັດ', hintText: 'eg.1'),
                ),
                TextField(
                  keyboardType: TextInputType.number,
                  controller: _numberController,
                  decoration: const InputDecoration(
                      labelText: 'ໝາຍເລກໂທລະສັບ', hintText: 'eg.10'),
                ),
                const SizedBox(
                  height: 10,
                ),
